...
3.	Double-click a query to open the related search results or criteria. NVivo restricts which queries can save parameters and which can save query results. If the save option is not on your screen, it's possible that it's not available.
